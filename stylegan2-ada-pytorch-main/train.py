...
def setup_training_loop_kwargs(
    ...
    # Dataset.
    data       = 'C:\\Users\\ipzac\\Documents\\Project Data\\Pokemon Sprites\\Clean Sprites\\Sprites', # Training dataset (required): <path>
    ...
    p          = 0.4, # Specify p for 'fixed' (required): <float>
